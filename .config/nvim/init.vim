...
-- require('hex').setup({ dump_cmd = 'xxd -g 1 -u', assemble_cmd = 'xxd -r', is_buf_binary_pre_read = function() end, is_buf_binary_post_read = function() end })
-- require('hex').setup({ dump_cmd = 'xxd -g 1 -u', assemble_cmd = 'xxd -r', is_buf_binary_pre_read = function() end, is_buf_binary_post_read = function() end })
require('nvim-treesitter.configs').setup({ ensure_installed = { "c", "rust", "zig", "go", "toml", "json" }, sync_install = false, auto_install = true, highlight = { enable = true, additional_vim_regex_highlighting = false}})
